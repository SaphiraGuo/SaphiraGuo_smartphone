...
class PostScreenState extends State<PostScreen>{
  ...
  final FirebaseStorage _storage = FirebaseStorage(storageBucket:'gs://neu-spring2021.appspot.com');
  ...
  String _startUpload(File image) {
    ...
    String filePath = 'guo_image/${DateTime.now()}';
    setState(() {
  ...
  void _postItem(){
    ...
    DocumentReference item_ref = Firestore.instance.document('guo_items_list/' + _controller_item.text);
